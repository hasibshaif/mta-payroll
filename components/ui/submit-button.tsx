...
export default function SubmitButton({
  ...
  return (
    ...
    >
      ...
      <span className="relative left-4 z-10 whitespace-nowrap px-8 font-semibold text-[#0039a6] transition-all duration-200 ease-in-out group-hover:-left-3 group-hover:text-white">
        {text}
      </span>
    </button>
  );
